 ...
 */
@WebServlet(name = "SkypeConferenceController")
public class SkypeConferenceController extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
          /*  String N= request.getParameter("name");
            ...
            String Link = "Dear Applicant ! " + N + " !  " + P + ". Click here to visit the website. " + "http://localhost:8080/AuthenticatingSkypeConferenceController?userName=" + N ;
