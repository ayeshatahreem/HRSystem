                ...
                <div class="col-md-12">
                    <div>
                        <ul class="nav nav-tabs nav-justified">
                            <li class="active"><a href="#tab-2" role="tab" data-toggle="tab"><i class="glyphicon glyphicon-list-alt"></i> Interview 2</a></li>
                            <li><a href="#tab-1" role="tab" data-toggle="tab"><i class="glyphicon glyphicon-blackboard"></i> Feedback Forms</a></li>
                        </ul>
                                ...
                                <div class="register-photo">
                                    <div class="form-container">
                                        ...
                                        <form method="post" action="FeedbackController">
                                            <h2 class="text-nowrap text-center text-info">Give feedback form !</h2>
                                            <div class="dropdown">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="emp0" placeholder="Employee Name" autocomplete="on" required>
                                            </div>
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="pos0" placeholder="Position" autocomplete="on" required>
                                            </div>
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="sal0" placeholder="Salary" autocomplete="on">
                                            </div>
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="wor0" placeholder="Working Hours" autocomplete="on" required>
                                            </div>
                                            <div class="form-group"></div>
                                            <div class="form-group">
                                                <button class="btn btn-info btn-block" type="submit" onclick = "this.submit.form();">Give feedback</button>
                                            </div><a class="btn btn-default btn-lg" role="button" href="https://itunes.apple.com/us/genre/ios/id36?mt=8"><i class="fa fa-apple"></i>Give feedback on App Store</a>
                                            <a class="btn btn-default btn-lg" role="button" href="https://play.google.com/store?hl=en"><i class="fa fa-google"></i>Give feedback on Play Store</a>
                                        </form>
                                    </div>
                                </div>
                                            ...
                                            <div class="tab-pane fade in active" role="tabpanel" id="current-2016">
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-lg-12">
                                                                <h1 class="h1">
                                                                    Review top 5 applicants </h1>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="content-wrap">
                                                    <form action="ReviewTopAppController" method="post" >
                                                ...
                                                <div class="row centered">
                                                    <div class="col-xs-12 one-column-row">
                                                        <h1 class="text-center news-bulletin-heading-text"> CVs received from 5Jan,17 - 4Apr,17 are :</h1></div>
                                                </div>
                                                <div class="row centered">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div role="tabpanel" class="panel-collapse collapse item-1">
                            <div class="panel-body text-center">
                                ...
                                <hr /><a href="AyeshaTahreemAamir.pdf" target="_blank">CV 2</a></div>
                        </div>
                    </div>
                    <div class="panel panel-default">
            ...
            <div class="col-md-12">
                <div role="tablist" aria-multiselectable="true" class="panel-group" id="accordion-2">
                    <div class="panel panel-default">
                        ...
                        <div role="tabpanel" class="panel-collapse collapse item-1">
                            <div class="panel-body text-center">
                                <hr /><a href="AyeshaTahreemAamir.pdf" target="_blank">CV 4</a></div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        <div role="tab" class="panel-heading">
                        ...
                        <div role="tabpanel" class="panel-collapse collapse item-2">
                            <div class="panel-body text-center">
                                <hr /><a href="AyeshaTahreemAamir.pdf" target="_blank">CV 5</a></div>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="well well-sm">
                                                    <form method="post" action="SecondInterviewCallToApp">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="name">
                                                                        Name</label>
                                                                    <input name="name" type="text" autocomplete="on" class="form-control" id="pname" placeholder="Enter name" required="required" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="email">
                                                                        Email Address</label>
                                ...
                                <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span>
                                                                        ...
                                                                        <input name="email" type="email" autocomplete="on" class="form-control" id="pemail" placeholder="Enter email" required="required" /></div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="subject">
                                                                        Subject</label>
                                                                    <select id="psubject" name="subject" class="form-control" required="required">
                                                                        ...
                                                                        <option value="Call for interview 2">Call for interview 2</option>
                                                                        <option value="Wait please">Wait please</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            <div class="well well-sm">
                <form method="post" action="LastEmail">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name">
                                Name</label>
                            <input type="text" class="form-control" name="qname"  autocomplete="on" id="name" placeholder="Enter name" required="required" />
                        </div>
                        <div class="form-group">
                            <label for="email">
                                Email Address</label>
                            <div class="input-group">
                                ...
                                <input type="email" name="qemail" class="form-control"  autocomplete="on" id="email" placeholder="Enter email" required="required" /></div>
                        </div>
                        <div class="form-group">
                            <label for="subject">
                                Subject</label>
                            <select id="subject" name="qsubject" class="form-control" required="required">
                                <option value="na" selected="">Choose One:</option>
                                <option value="Congo! U made it!">Congo! U made it!</option>
                                <option value="Sorry! Apply next time !">Sorry! Apply next time !</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
