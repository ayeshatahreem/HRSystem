...
<head>
    ...
    <link rel="stylesheet" href="assets/css/Small-portfolio.css">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand navbar-link" href="home.jsp"> <img src="assets/img/favicon.png"></a>
                <button class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>
            </div>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="home.jsp" target="_parent"> <i class="glyphicon glyphicon-home"></i> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation">
                                <a href="home.jsp"> <i class="glyphicon glyphicon-home"></i> Home</a>
                            </li>
                            <li role="presentation"><a href="FAQs.jsp"><i class="glyphicon glyphicon-cog"></i> FAQs </a></li>
                            <li role="presentation"><a href="Contact.jsp"><i class="glyphicon glyphicon-earphone"></i> Contact Us</a></li>
                        </ul>
                    </li>
                    <li role="presentation">
                        <a href="ApplicantDashboard.jsp"> <i class="glyphicon glyphicon-dashboard"></i> My Dashboard</a>
                    </li>
                    <li role="presentation">
                        <a href="Jobs.jsp"> <i class="fa fa-list-alt"></i> Jobs</a>
                    </li>
                </ul>
                <form class="navbar-form navbar-left" target="_self">
                    <div class="form-group">
                        <label class="control-label" for="search-field"><i class="glyphicon glyphicon-search"></i></label>
                        <input class="form-control search-field" type="search" name="search" placeholder="Search CodeClan" id="search-field">
                    </div>
                </form><a class="btn btn-default navbar-btn navbar-right action-button" role="button" href="LogOut"><i class="glyphicon glyphicon-off"></i> Log Out</a></div>
        </div>
    </nav>
</div>
