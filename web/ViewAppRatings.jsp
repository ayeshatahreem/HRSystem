    ...
    <form>
        <div>
            ...
            <div>
                <table>
                    <tbody>
                    <c:forEach items="${requestScope.SL}" var="SL">
                        <tr>
                            <th style="height:40px;width:675px; background:#000000; color:white">Job # </th>
                            <th style="height:40px;width:675px; background:#000000; color:white"><c:out value="${SL.GetJobID()}"></c:out></th>
                        </tr>
                        <tr>
                            <th style="height:35px;width:675px; background:#c9efeb;">Applicant ID</th>
                            <th style="height:35px;width:675px; background:#c9efeb;"><c:out value="${SL.GetAppID()}"></c:out></th>
                        </tr>
                        <tr>
                            <th style="height:35px;width:675px; background:#afd6d2;">Applicant Name</th>
                            <th style="height:35px;width:675px; background:#afd6d2;"><c:out value="${SL.GetUserName()}"></c:out></th>
                        </tr>
                        <tr>
                            <th style="height:35px;width:675px; background:#c9efeb;">Rating</th>
                            <th style="height:35px;width:675px; background:#c9efeb;"><c:out value="${SL.GetRating()}"></c:out></th>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
