    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand navbar-link" href="ApplicantDashboard.jsp"> <img src="assets/img/favicon.png"></a>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    ...
                    <li role="presentation">
                        <a href="ApplicantDashboard.jsp"> <i class="glyphicon glyphicon-dashboard"></i> Dashboard</a>
                    </li>
                    <li role="presentation">
                        <a href="Jobs.jsp"> <i class="fa fa-list-alt"></i> Jobs</a>
                    </li>
                    <li role="presentation"><a href="Profile.jsp"><i class="glyphicon glyphicon-user"></i> Profile</a></li>
                </ul>
