...
<body>
<div>
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-button" data-aos="fade-up">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand navbar-link" href="index.jsp"> <img src="assets/img/favicon.png"></a>
